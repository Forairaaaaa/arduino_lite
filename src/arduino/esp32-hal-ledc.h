...
#include "freertos/semphr.h"
     ...
     *
     * @param pin GPIO pin
     * @param note select note to be set (NOTE_C, NOTE_Cs, NOTE_D, NOTE_Eb, NOTE_E, NOTE_F, NOTE_Fs, NOTE_G, NOTE_Gs, NOTE_A,
     * NOTE_Bb, NOTE_B).
     ...
     */
    bool
    ledcFadeWithInterrupt(uint8_t pin, uint32_t start_duty, uint32_t target_duty, int max_fade_time_ms, void (*userFunc)(void));
