...
float temperatureRead() { return (temprature_sens_read() - 32) / 1.8; }
...
unsigned long ARDUINO_ISR_ATTR micros() { return (unsigned long)(esp_timer_get_time()); }
...
arduino_panic_handler_t get_arduino_panic_handler(void) { return _panic_handler; }

void* get_arduino_panic_handler_arg(void) { return _panic_handler_arg; }
